<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="paymentCancel.aspx.cs" Inherits="ClientControl.Operations.paymentCancel" MasterPageFile="~/base.Master"%>
            ...
            <article>
                <form runat="server" id="form1">
                    ...
                    <asp:GridView ID="GridView1" AutoGenerateColumns="False" CssClass="GridViewStyle"
                        ...
                        <Columns>
                            <asp:BoundField HeaderText="idPago" DataField="idPago"/>
